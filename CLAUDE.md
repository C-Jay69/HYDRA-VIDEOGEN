# VidAI - AI Video Creation Platform

Full-stack AI-powered video creation platform inspired by InVideo.io. Create professional videos from text prompts with AI assistance.
...
- Custom gradient buttons: `bg-gradient-to-r from-[#6c3bff] to-[#00d4ff]`
...
4. **RLS awareness** - Use `client.ts` for frontend queries
